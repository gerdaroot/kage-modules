...
| `.tta <ссылка>` | Скачать звук из видео в m4a, с названием трека и автором |
...
- Для `.tta` и обложек нужен ffmpeg. Без него видео всё равно скачается, просто без обложки.
