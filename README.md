...
Отвечаешь командой на медиа — получаешь кружок или голосовое, как будто записал его сам.

| Команда | Описание |
|---|---|
| `.circle [секунда]` / `.krug` | Кружок из видео, GIF или другого кружка: квадрат 640×640 по центру кадра, до 60 секунд (лимит Telegram). Можно указать, с какой секунды начать: `.circle 15` |
